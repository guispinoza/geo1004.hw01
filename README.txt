...
The triangulation is done using the values present in the gmap structure, where new points created using barycenter points for the faces and the edges and used to triangulate.  
